...
export declare namespace inject {
     ...
     * @param metadata Optional metadata to help the injection
     */
    const getter: (bindingKey: BindingAddress<any>, metadata?: InjectionMetadata | undefined) => (target: Object, member: string, methodDescriptorOrParameterIndex?: number | TypedPropertyDescriptor<any> | undefined) => void;
    /**
     ...
     * @param metadata Optional metadata to help the injection
     */
    const setter: (bindingKey: BindingAddress<any>, metadata?: InjectionMetadata | undefined) => (target: Object, member: string, methodDescriptorOrParameterIndex?: number | TypedPropertyDescriptor<any> | undefined) => void;
    /**
