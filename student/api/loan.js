...
class Loan extends State {
    ...
    static createInstance(issuer, LoanID, CustomerID, LoanName, BeginDate, BeginAmt, NumPayments) {
        return new Loan({ issuer, LoanID, CustomerID, LoanName, BeginDate, BeginAmt, NumPayments});
    }
